...
exports.default = {
    ...
    data: new discord_js_1.SlashCommandBuilder()
        ...
        .addChoices({ name: '📋 Ficha Completa', value: 'info' }, { name: '🖼️ Apenas Foto', value: 'photo' })),
    ...
    async execute(message, args) {
        ...
        const embed = new discord_js_1.EmbedBuilder()
            ...
            .addFields({ name: '👤 Identidade', value: `**Nome:** ${targetUser.username}\n**Apelido:** ${targetMember.nickname || "Nenhum"}\n**ID:** \`${targetUser.id}\``, inline: false }, { name: '📅 Datas Importantes', value: `**Criou a Conta:** ${criadoEm}\n**Entrou no Server:** ${entrouEm}`, inline: false }, { name: '🏆 Rank de Antiguidade', value: `Este foi o membro **Nº ${joinPosition}** a entrar no servidor!`, inline: false }, { name: '🛡️ Cargos', value: finalRoles, inline: false })
