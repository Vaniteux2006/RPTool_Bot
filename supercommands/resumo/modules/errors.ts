...
// Motivo de parada, já formatado como Interrupcao (titulo + detalhe).
...
// Tradução do erro fatal (fora do loop de blocos) para uma frase útil ao usuário.
export function descreverErroFatal(error: any): string {
    ...
    return '❌ Erro ao puxar mensagens ou contatar a IA.';
}
