    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
        ...
        entries: [
            ...
            },
            {
                ...
                summary: 'Console de JavaScript — mostra o valor da expressão.',
                usage: ['rp!console [código]', 'rp!console ```js …```'],
                details: 'Funciona como o console do navegador: exibe o **valor** da expressão, sem precisar de `console.log`. `rp!console 0.1 + 0.2` responde `0.30000000000000004`. Aceita bloco de código com várias linhas — o que estiver dentro das crases roda junto. Editar a mensagem re-executa.\n\nRoda isolado em WebAssembly (QuickJS), dentro do próprio bot: sem acesso a rede, arquivos ou variáveis de ambiente. Teto de 3 segundos de CPU, 32 MB de memória e 200 linhas — loop infinito é cortado, não trava o bot.',
                subs: [
                    { usage: 'rp!console 0.1 + 0.2', desc: 'Avalia uma expressão e mostra o valor' },
                    { usage: 'rp!console ```js …```', desc: 'Bloco com várias linhas (define e usa na mesma mensagem)' },
                ],
                aliases: ['js', 'run', 'eval'],
                keywords: ['javascript', 'codigo', 'eval', 'sandbox', 'dev', 'js', 'devtools', 'expressao', 'testar'],
            },
        ],
    },
    // ═══════════════════════════════════════════════════════════════════════
