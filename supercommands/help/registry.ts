    ...
    // ═══════════════════════════════════════════════════════════════════════
    {
        ...
        entries: [
            ...
            },
            {
                ...
                details: 'Cada OC tem sua própria mochila. Há dois tipos de item: **de loja** (a staff cria com `additem`, têm preço, dá pra comprar/vender) e **pessoais** (você mesmo cria com `add` — coisas de RP como uma carta, um amuleto, a espada do pai; sem preço, fora da loja, mas dá pra dar/usar/descartar). Itens pessoais aparecem com ✎ na mochila.',
                ...
                keywords: ['inventario', 'inventário', 'mochila', 'item', 'itens', 'loja', 'shop', 'comprar', 'vender', 'bag', 'unbelieva', 'pessoal', 'anotar', 'criar item', 'descartar', 'drop'],
            },
        ],
    },
];
